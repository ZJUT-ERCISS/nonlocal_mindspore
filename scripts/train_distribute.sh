...
echo "For example: bash train_distribute.sh /home/nonlocal data/kinetics-400"
echo "================================================================================================"
set -e
if [ $# -lt 2 ]; then
...
mpirun -n 8 --allow-run-as-root python $PYTHON_PATH/src/example/nonlocal_kinetics400_train.py --run_distribute True \
